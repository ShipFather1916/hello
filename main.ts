namespace SpriteKind {
    ...
    export const hitbot = SpriteKind.create()
}
...
function Quiz () {
    ...
    scene.setBackgroundImage(img`
        ...
        ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        `)
    tiles.setCurrentTilemap(tilemap`level131`)
    s1 = sprites.create(img`
        ................................................................................................................................................................
        ................................................................................................................................................................
        ................................................................................................................................................................
        ................................................................................................................................................................
        ...
        ................................................................................................................................................................
        `, SpriteKind.hitbot)
    a1 = textsprite.create(answerChoices[4 * quizlevel])
    a1.left = 8
    a1.y = 18
    a1.setOutline(1, 15)
    ...
    if (quizSubject == 0) {
        ...
        game.setDialogTextColor(15)
        game.showLongText("CONGRADULATIONS...Now you've proven yourself worthy of Skyrim...Oh and this...", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("AP Computer Science key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    } else if (quizSubject == 2) {
        ...
        game.setDialogTextColor(15)
        game.showLongText("Good Good Good...", DialogLayout.Bottom)
        game.showLongText("Now take the key and LEAVE!", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("Chemistry key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    } else if (quizSubject == 3) {
        ...
        tiles.placeOnTile(CalcAB, tiles.getTileLocation(4, 4))
        game.setDialogTextColor(15)
        game.showLongText("T H I S  O U T C O M E  I S  R A T H E R  I M P R E S S I V E. . .", DialogLayout.Bottom)
        game.showLongText("Y O U  H A V E  E A R N E D  T H I S. . .", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("Calculus AB key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    } else if (quizSubject == 4) {
        ...
        game.showLongText("Y O U  H A V E  E A R N E D  T H I S. . .", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("Pre-Calculus key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        calKey += 1
        quiz_level = 0
    } else if (quizSubject == 5) {
        ...
        tiles.placeOnTile(Art, tiles.getTileLocation(5, 4))
        game.setDialogTextColor(15)
        game.showLongText("T H I S  O U T C O M E  I S  R A T H E R  I M P R E S S I V E. . .", DialogLayout.Bottom)
        game.showLongText("Y O U  H A V E  E A R N E D  T H I S. . .", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("Physics key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    } else if (quizSubject == 6) {
        ...
        game.setDialogTextColor(15)
        game.showLongText("YES YES YES!!!", DialogLayout.Bottom)
        game.showLongText("YOU HAVE PROVEN YOURSELF TO BE TRUE MAGA!", DialogLayout.Bottom)
        game.showLongText("TAKE THIS MY CHILD...", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("World History key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    } else if (quizSubject == 7) {
        ...
        game.setDialogTextColor(15)
        game.showLongText("Seig He---I mean good job student!", DialogLayout.Bottom)
        game.showLongText("Now you can have this key I found...", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("Art key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    } else if (quizSubject == 8) {
        ...
        game.setDialogTextColor(15)
        game.showLongText("OH QUITE A FABULOUS SUBOGULOUS JOB!!!", DialogLayout.Bottom)
        game.showLongText("I BELEIVE YOU HAVE ANED THISE...", DialogLayout.Bottom)
        pauseUntil(() => controller.A.isPressed())
        game.showLongText("LANGUAGE key earned...", DialogLayout.Center)
        music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
        keyNumber += 1
        quiz_level = 0
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
    pause(500)
    game.showLongText("Chemistry door Key found!", DialogLayout.Bottom)
    chemKey += 1
})
        ...
        if (cutscene == 0) {
            ...
            if (Floor == 2) {
                if (location10.column == 34 && location10.row == 39) {
                    ...
                    tiles.setCurrentTilemap(tilemap`level15`)
                    tiles.placeOnTile(mySprite, tiles.getTileLocation(33, 39))
                } else if (location10.column == 3 && location10.row == 14) {
                    tiles.setCurrentTilemap(tilemap`level15`)
            ...
            if (Floor == 3) {
                if (location10.column == 37 && location10.row == 40) {
                    ...
                    tiles.setCurrentTilemap(tilemap`level45`)
                    tiles.placeOnTile(mySprite, tiles.getTileLocation(3, 13))
                } else if (location10.column == 1 && location10.row == 14) {
                    tiles.setCurrentTilemap(tilemap`level45`)
                    tiles.placeOnTile(mySprite, tiles.getTileLocation(2, 18))
                }
            }
        }
    }
...
let Art: Sprite = null
let Physics: Sprite = null
let Precalc: Sprite = null
...
let a3: TextSprite = null
let a2: TextSprite = null
let a1: TextSprite = null
let quiz_level = 0
let Score = 0
let answerChoices: string[] = []
let Correct_Answers: string[] = []
let End = false
let CalcAB: Sprite = null
let quizlevel = 0
let movement = 0
let calKey = 0
let keyNumber = 0
...
scene.setBackgroundImage(img`
    ...
    
    `)
pauseUntil(() => controller.A.isPressed())
tiles.setCurrentTilemap(tilemap`level2`)
scene.setBackgroundImage(img`
